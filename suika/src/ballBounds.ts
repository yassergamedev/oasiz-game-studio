...
export const COMMITTED_BALL_BOUNDS: Record<string, BallColliderConfig> = {
  ...
  rugby: {
    mode: "polygon",
    vertices: [
      { x: -1.2038663608711917, y: 0.7299653387742155 },
      { x: -1.6077441077441075, y: 0.41152326912441645 },
      { x: -1.2116332406187478, y: -0.3651647056311911 },
      { x: -0.5902828608142617, y: -0.8234106107369995 },
      { x: 0.45047902535825235, y: -1.0020488449307892 },
      { x: 1.1727988418809674, y: -0.7457418132614387 },
      { x: 1.6155109874916636, y: -0.3884653448738593 },
      { x: 1.2970689178418646, y: 0.34162135139641175 },
      { x: 0.5048471835911449, y: 0.885302933725337 },
      { x: -0.5669822215715935, y: 0.986272370443566 },
    ],
  },
